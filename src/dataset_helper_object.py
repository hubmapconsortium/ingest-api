...
class DatasetHelper:
    ...
    def verify_dataset_title_info(self, dataset_uuid: str, user_token: str) -> array:
        entity_api = hubmap_sdk.EntitySdk(token=user_token, service_url=_entity_api_url)
        search_api = hubmap_sdk.SearchSdk(token=user_token, service_url=_search_api_url)
    ...
    def handle_thumbnail_file(self, thumbnail_file_abs_path: str, entity_api: hubmap_sdk.EntitySdk, dataset_uuid: str,
